...
//
// Purpose:
// - To define a consistent way of managing routes throughout the app.import 'package:flutter_bloc/flutter_bloc.dart';
...
class AppRoutes {
  static GoRouter goRouter = GoRouter(
    redirect: (context, state) async {
      ...
      if (!isLoggedin && state.uri.toString() == '/' && isVerified) {
      ...
      if (!isLoggedin && !isVerified && state.uri.toString() == '/home') {

...
// Function to exchange the authorization code for an access token using Dio
  ...
  Future<List<Contact>> fetchChats() async {
    try {
      const String token =
          'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..b9BoVnpwnZlhh_7vaydgP8vzCGkvmJ0g7aZJqlfAqH4';
